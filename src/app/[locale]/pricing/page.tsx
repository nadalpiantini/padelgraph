...
const plans: Plan[] = [
  {
    ...
    features: [
      ...
      { name: 'Travel Plans', included: false },
      { name: 'Advanced Analytics', included: false },
      { name: 'Achievement System', included: false },
  ...
  },
  {
    ...
    interval: 'month',
    popular: true,
    paypalPlanId: process.env.NEXT_PUBLIC_PAYPAL_PLAN_PRO || 'P-PRO123',
    color: 'border-blue-500',
    icon: <Zap className="h-6 w-6 text-blue-500" />,
    features: [
      { name: 'Tournament Creation', included: true, value: 'Unlimited' },
      { name: 'Auto-Match', included: true, value: 'Unlimited' },
      { name: 'Player Recommendations', included: true, value: 'Unlimited' },
      { name: 'Travel Plans', included: true, value: '5/month' },
  ...
  },
  {
    ...
    currency: 'USD',
    interval: 'month',
    paypalPlanId: process.env.NEXT_PUBLIC_PAYPAL_PLAN_PREMIUM || 'P-PREMIUM123',
    ...
    features: [
      ...
      { name: 'Auto-Match', included: true, value: 'Unlimited' },
      { name: 'Player Recommendations', included: true, value: 'Unlimited' },
      { name: 'Travel Plans', included: true, value: 'Unlimited' },
      { name: 'Advanced Analytics', included: true },
      { name: 'Achievement System', included: true },
  ...
  },
  {
    ...
    currency: 'USD',
    interval: 'month',
    paypalPlanId: process.env.NEXT_PUBLIC_PAYPAL_PLAN_CLUB || 'P-CLUB123',
